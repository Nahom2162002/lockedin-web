  ...
  return (
    ...
    >
      ...
      <section style={{ maxWidth: 720, margin: '0 auto', padding: '60px 24px 100px' }}>
        ...
        <h1 style={{ fontSize: 36, fontWeight: 800, margin: '32px 0 8px' }}>{title}</h1>
        <p style={{ color: 'rgba(200,225,255,.45)', fontSize: 14, marginBottom: 48 }}>Last updated: {lastUpdated}</p>
